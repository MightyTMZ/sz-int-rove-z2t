...
filename = "api_data/flight_searches/YYZ_to_FRA.json"

print("YYZ to FRA")
print("For 2 adults and 2 children")
print("From 2025-10-27 to 2025-11-03")
print("------------------------------------------------------------------\n")
...
with open(filename) as file:
    ...
    print(f"You said you wanted to spend 70000 points")
