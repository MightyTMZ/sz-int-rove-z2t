...
def search_flight_offers(origin, destination, departure_date, return_date=None, adults=1, children=None, max_price=None, currency_code='USD'):
    """
...
if __name__ == "__main__":
    ...
    with open(f"hack_routing/{origin_airport_code}_to_{destination_airport_code}.json", "w", encoding="utf-8") as f:
    ...
    py_filename = f"hack_routing/{origin_airport_code}_to_{destination_airport_code}.py"

    with open(py_filename, "w", encoding="utf-8") as py_file:
        py_file.write(f'''
import json

filename = "hack_routing/{origin_airport_code}_to_{destination_airport_code}.json"
